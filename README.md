...
Project Rivers provides the Go client library and the REST API for reading water level and temperature data from stations located in rivers in Ireland.
